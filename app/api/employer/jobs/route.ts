...
export async function POST(request: NextRequest) {
  ...
  try {
    logInfo('employer-job-post-start', {
      requestId,
    ...
    try {
      ...
      logError('employer-job-post-supabase-init', supabaseError, {
        requestId,
    ...
    try {
      ...
      logError('employer-job-post-auth', authError, {
        requestId,
    ...
    try {
      ...
      logError('employer-job-post-parse', parseError, {
        requestId,
    ...
    try {
      ...
      logError('employer-job-post-validation', validationError, {
        requestId,
    ...
    try {
      ...
      if (insertError) {
        logError('employer-job-post-db-insert', insertError, {
          requestId,
      ...
      logInfo('employer-job-post-success', {
        requestId,
      ...
      logError('employer-job-post-db-error', dbError, {
        requestId,
    ...
    const requestDurationMs = performance.now() - requestStartTime
    logError('employer-job-post-unexpected', unexpectedError, {
      requestId,
